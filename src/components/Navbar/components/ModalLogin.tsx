                            ...
                            <div className='border-0 w-[438px] p-8  shadow-lg relative flex flex-col items-center justify-center gap-6  bg-base-100 outline-none focus:outline-none rounded-lg'>
                                ...
                                <div className='flex flex-col gap-8 w-full'>
                                    <div className=' flex flex-col items-center gap-2'>
                                        <span className='font-medium text-5 leading-7 text-base-900 text-center'>
                                            Login or Sign up
                                        </span>
                                        <span className='text-1 leading-[18px] text-base-700 font-sans text-center w-[288px]'>
                                    ...
                                    <div className=' flex flex-col w-full gap-4'>
                                        <div className=' flex flex-row gap-3 items-center rounded-[4px] bg-base-300 border border-base-400 p-4'>
                                            ...
                                            <span className='text-1 text-base-700 font-sans font-normal'>
                                                Chamjo uses{" "}
                                                <span>
                                                    <Link
                                        ...
                                        <Button
                                            className='!border-none !rounded  text-base-100 gap-2 text-2 justify-center font-sans font-normal leading-[22px] hover:text-base-3'
                                            block
                                        ...
                                        <p className='text-base-700 text-1  font-sans font-normal text-center'>
                                            By continuing, you agree to our{" "}
                                            <span
                                                className='text-base-900 font-medium cursor-pointer  font-sans'
                                                onClick={() => {
                                                    window.open(
